...
export { default as IconOriginSize } from './IconOriginSize.vue';
export { default as IconPlus } from './IconPlus.vue';
export { default as IconRight } from './IconRight.vue';
export { default as IconRotateLeft } from './IconRotateLeft.vue';
export { default as IconRotateRight } from './IconRotateRight.vue';
