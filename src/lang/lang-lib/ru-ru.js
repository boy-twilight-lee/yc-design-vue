...
const e = {
    ...
    formatMonth: 'MM/YYYY',
    today: 'Cегодня',
    view: { month: 'месяц', year: 'год', week: 'Неделя', day: 'день' },
    month: {
      long: {
        January: 'января',
        February: 'февраля',
  ...
  a = {
    ...
    drawer: { okText: 'OK', cancelText: 'Отмена' },
    popconfirm: { okText: 'OK', cancelText: 'Отмена' },
    modal: { okText: 'OK', cancelText: 'Отмена' },
    pagination: {
      goto: 'Перейти',
      page: 'Страница',
      countPerPage: '/ стр.',
    ...
    table: { okText: 'OK', resetText: 'перезагрузить' },
    upload: {
      start: 'Начало',
      cancel: 'Отмена',
      delete: 'Удалить',
    ...
    form: {
      validateMessages: {
        ...
        string: {
          minLength:
            '`#{field}` должно содержать не менее #{minLength} символов',
          maxLength:
            '`#{field}` должно содержать не более #{maxLength} символов',
          length:
            'Длина строки в #{field} должна быть ровно #{length} символов',
