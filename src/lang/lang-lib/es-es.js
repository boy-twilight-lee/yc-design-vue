...
const e = {
    ...
    formatMonth: 'M/YYYY',
    today: 'Hoy',
    view: { month: 'Mes', year: 'Año', week: 'Semana', day: 'Fecha' },
    month: {
      long: {
        January: 'Enero',
        February: 'Febrero',
  ...
  a = {
    ...
    drawer: { okText: 'Aceptar', cancelText: 'Cancelar' },
    popconfirm: { okText: 'Aceptar', cancelText: 'Cancelar' },
    modal: { okText: 'Aceptar', cancelText: 'Cancelar' },
    pagination: {
      goto: 'Ir a',
      page: 'Página',
      countPerPage: '/ página',
    ...
    table: { okText: 'Aceptar', resetText: 'Reiniciar' },
    upload: {
      start: 'Comienzo',
      cancel: 'Cancelar',
      delete: 'Eliminar',
