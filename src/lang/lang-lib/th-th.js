...
const e = {
    ...
    today: 'วันนี้',
    view: { month: 'เดือน', year: 'ปี', week: 'สัปดาห์', day: 'วัน' },
    month: {
      long: {
        January: 'มกราคม',
        February: 'กุมภาพันธ์',
  ...
  t = {
    ...
    drawer: { okText: 'ตกลง', cancelText: 'ยกเลิก' },
    popconfirm: { okText: 'ตกลง', cancelText: 'ยกเลิก' },
    modal: { okText: 'ตกลง', cancelText: 'ยกเลิก' },
    pagination: {
      goto: 'ไปที่',
      page: 'หน้า',
      countPerPage: ' / หน้า',
    ...
    table: { okText: 'ตกลง', resetText: 'รีเซ็ต' },
    upload: {
      start: 'เริ่ม',
      cancel: 'ยกเลิก',
      delete: 'ลบ',
