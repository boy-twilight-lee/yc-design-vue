...
const t = {
    ...
    today: 'Hôm nay',
    view: { month: 'Tháng', year: 'Năm', week: 'Tuần', day: 'Ngày' },
    month: {
      long: {
        January: 'Tháng Một',
        February: 'Tháng Hai',
  ...
  e = {
    ...
    drawer: { okText: 'Đồng ý', cancelText: 'Hủy bỏ' },
    popconfirm: { okText: 'Đồng ý', cancelText: 'Hủy bỏ' },
    modal: { okText: 'Đồng ý', cancelText: 'Hủy bỏ' },
    pagination: {
      goto: 'Đi tới',
      page: 'Trang',
    ...
    table: { okText: 'Đồng ý', resetText: 'Thiết lập lại' },
    upload: {
      start: 'Bắt đầu',
      cancel: 'Hủy bỏ',
      delete: 'Xóa bỏ',
