...
const e = {
    ...
    formatMonth: 'MM/YYYY',
    today: 'Hoje',
    view: { month: 'Mês', year: 'Ano', week: 'Semana', day: 'Dia' },
    month: {
      long: {
        January: 'Janeiro',
        February: 'Fevereiro',
  ...
  a = {
    ...
    drawer: { okText: 'Ok', cancelText: 'Cancelar' },
    popconfirm: { okText: 'Ok', cancelText: 'Cancelar' },
    modal: { okText: 'Ok', cancelText: 'Cancelar' },
    pagination: {
      goto: 'Vamos para',
      page: 'Página',
      countPerPage: ' / Página',
    ...
    table: { okText: 'Ok', resetText: 'Redefinir' },
    upload: {
      start: 'Iniciar',
      cancel: 'Cancelar',
      delete: 'Excluir',
