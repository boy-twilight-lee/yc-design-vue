...
const e = {
    ...
    today: 'Heute',
    view: { month: 'Monat', year: 'Jahr', week: 'Woche', day: 'Tag' },
    month: {
      long: {
        January: 'Januar',
        February: 'Februar',
  ...
  t = {
    ...
    drawer: { okText: 'OK', cancelText: 'Abbrechen' },
    popconfirm: { okText: 'OK', cancelText: 'Abbrechen' },
    modal: { okText: 'OK', cancelText: 'Abbrechen' },
    pagination: {
      goto: 'Gehe zu',
      page: '',
      countPerPage: '/ Seite',
    ...
    table: { okText: 'OK', resetText: 'Zurücksetzen' },
    upload: {
      start: 'Anfang',
      cancel: 'Abbrechen',
      delete: 'löschen',
