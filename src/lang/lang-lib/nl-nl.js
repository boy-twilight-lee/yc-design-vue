...
const e = {
    ...
    formatMonth: 'MM-YYYY',
    today: 'Vandaag',
    view: { month: 'Maand', year: 'Jaar', week: 'Week', day: 'Dag' },
    month: {
      long: {
        January: 'januari',
        February: 'februari',
  ...
  a = {
    ...
    drawer: { okText: 'OK', cancelText: 'Annuleren' },
    popconfirm: { okText: 'OK', cancelText: 'Annuleren' },
    modal: { okText: 'OK', cancelText: 'Annuleren' },
    pagination: {
      goto: 'Ga naar',
      page: 'pagina',
      countPerPage: '/ pagina',
    ...
    table: { okText: 'OK', resetText: 'Resetten' },
    upload: {
      start: 'Start',
      cancel: 'Annuleren',
      delete: 'Verwijderen',
    ...
    form: {
      validateMessages: {
        ...
        boolean: { true: 'Moet true zijn', false: 'Moet false zijn' },
      },
    },
    colorPicker: {
