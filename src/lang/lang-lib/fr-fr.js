...
const e = {
    ...
    formatMonth: 'MM/YYYY',
    today: "Aujourd'hui",
    view: { month: 'Mois', year: 'Année', week: 'Semaine', day: 'Date' },
    month: {
      long: {
        January: 'Janvier',
        February: 'Février',
  ...
  r = {
    ...
    drawer: { okText: 'OK', cancelText: 'Annuler' },
    popconfirm: { okText: 'OK', cancelText: 'Annuler' },
    modal: { okText: 'OK', cancelText: 'Annuler' },
    pagination: {
      goto: 'Aller à',
      page: 'Page',
      countPerPage: '/ page',
    ...
    table: { okText: 'OK', resetText: 'Réinitialiser' },
    upload: {
      start: 'Démarrer',
      cancel: 'Annuler',
      delete: 'Supprimer',
