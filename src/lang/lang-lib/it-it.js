...
const e = {
    ...
    today: 'Oggi',
    view: { month: 'Mese', year: 'Anno', week: 'Settimana', day: 'Giorno' },
    month: {
      long: {
        January: 'Gennaio',
        February: 'Febbraio',
  ...
  a = {
    ...
    drawer: { okText: 'OK', cancelText: 'Annulla' },
    popconfirm: { okText: 'OK', cancelText: 'Annulla' },
    modal: { okText: 'OK', cancelText: 'Annulla' },
    pagination: {
      goto: 'vai a',
      page: '',
      countPerPage: '/ pagina',
    ...
    table: { okText: 'OK', resetText: 'Ripristina' },
    upload: {
      start: 'Inizio',
      cancel: 'Annulla',
      delete: 'Elimina',
    ...
    image: { loading: 'Caricamento in corso' },
    imagePreview: {
