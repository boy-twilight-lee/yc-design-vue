...
const a = {
    ...
    today: 'Hari ini',
    view: { month: 'Bulan', year: 'Tahun', week: 'Minggu', day: 'Hari' },
    month: {
      long: {
        January: 'Januari',
        February: 'Februari',
  ...
  e = {
    ...
    drawer: { okText: 'Baik', cancelText: 'Membatalkan' },
    popconfirm: { okText: 'Baik', cancelText: 'Membatalkan' },
    modal: { okText: 'Baik', cancelText: 'Membatalkan' },
    pagination: {
      goto: 'Pergi ke',
      page: 'Halaman',
    ...
    table: { okText: 'Baik', resetText: 'Setel ulang' },
    upload: {
      start: 'Mulailah',
      cancel: 'Membatalkan',
      delete: 'Menghapus',
