...
const e = {
    ...
    today: 'اليوم',
    view: { month: 'شهر', year: 'عام', week: 'أسبوع', day: 'يوم' },
    month: {
      long: {
        January: 'ديسمبر',
        February: 'نوفمبر',
  ...
  a = {
    ...
    drawer: { okText: 'موافق', cancelText: 'إلغاء' },
    popconfirm: { okText: 'موافق', cancelText: 'إلغاء' },
    modal: { okText: 'موافق', cancelText: 'إلغاء' },
    pagination: {
      goto: 'اذهب إلى',
      page: 'الصفحة',
    ...
    table: { okText: 'موافق', resetText: 'إعادة تعيين' },
    upload: {
      start: 'بداية',
      cancel: 'يلغي',
      delete: 'حذف',
