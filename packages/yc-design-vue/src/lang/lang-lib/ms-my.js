...
const a = {
  ...
  e = {
    ...
    drawer: { okText: 'okey', cancelText: 'batalkan' },
    popconfirm: { okText: 'okey', cancelText: 'batalkan' },
    modal: { okText: 'okey', cancelText: 'batalkan' },
    pagination: {
      goto: 'pergi ke',
      page: 'Halaman',
    ...
    table: { okText: 'okey', resetText: 'set semula' },
    upload: {
      start: 'mulakan',
      cancel: 'batalkan',
      delete: 'padam',
