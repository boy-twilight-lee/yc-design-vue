...
const e = {
    ...
    today: 'ថ្ងៃនេះ',
    view: { month: 'ខែ', year: 'ឆ្នាំ', week: 'សប្តាហ៍', day: 'ថ្ងៃ' },
    month: {
      long: {
        January: 'មករា',
        February: 'កុម្ភៈ',
  ...
  t = {
    locale: 'km-KH',
    empty: { description: 'គ្មាន​ទិន្នន័យ' },
    drawer: { okText: 'យល់ព្រម', cancelText: 'បោះបង់' },
    popconfirm: { okText: 'យល់ព្រម', cancelText: 'បោះបង់' },
    modal: { okText: 'យល់ព្រម', cancelText: 'បោះបង់' },
    pagination: {
      goto: 'ទៅកាន់',
      page: 'ទំព័រ',
      countPerPage: ' / ទំព័រ',
    ...
    table: { okText: 'យល់ព្រម', resetText: 'កំណត់ឡើងវិញ' },
    upload: {
      start: 'ចាប់ផ្តើម',
      cancel: 'បោះបង់',
      delete: 'លុប',
