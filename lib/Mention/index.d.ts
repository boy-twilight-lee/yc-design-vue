import { App } from 'vue';
import { default as _Mention } from './index.vue';
    ...
    new (...args: any[]): import('vue').CreateComponentPublicInstanceWithMixins<Readonly<import('./type').MentionProps> & Readonly<{
        ...
        autoCompleteRef: ({
            ...
            $props: {
                ...
                readonly data?: import('..').SelectOptions | undefined;
                ...
                readonly vistualListProps?: import('..').VirtualListProps | undefined;
            ...
            $slots: Readonly<import('..').AutoCompleteSlots> & import('..').AutoCompleteSlots;
        }) | null;
